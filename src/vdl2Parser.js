/**
 * ============================================================================
 * FICHIER : src/vdl2Parser.js
 * ============================================================================
 * C'est le clone asynchrone du Web Worker (parser.worker.js), utilisé ici
 * comme module classique pour des environnements où les Workers ne seraient
 * pas supportés, ou pour des tests unitaires Node.js (exécutés sans navigateur).
 * 
 * Son rôle est d'absorber des méga-octets de texte brut (les logs radio),
...
export function parseLogs(rawText) {
    ...
    // On lance l'analyse pédagogique avant de renvoyer les données finies
